...
public class PierTester {
    public static void main(String[] args) {
        ...
        Pier waterfront = new Pier("Waterfront", transLink, 2);
        ...
        PierTime londsdaleQuay = new PierTime("Lonsdale Quay",
        ...
        PierTimeStack stanleyPark = new PierTimeStack("Stanley Park", transLink, 3, LocalTime.of(9, 0), LocalTime.of(14, 0));
