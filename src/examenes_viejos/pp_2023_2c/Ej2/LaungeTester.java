...
public class LaungeTester {
    public static void main(String[] args) {
       ...
       Lounge lounge = new Lounge("Ezeiza Lounge", central);
        ...
        // de todas las aerolíneas que cuenten con al menos un pase cuando está abierto
       LimitedLaunge capLounge = new LimitedLaunge("The Centurion", central, 3);
       ...
       AirlineLaunge airLounge = new AirlineLaunge("VIP Lounge", central, 4, "LATAM");
